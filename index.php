			...
			if(response){
				...
				$.each(response,function(i,v){
					html+=`<tr>
					 ...
					 <td> ${v.gender} </td>
					 <td> ${v.email} </td>
					 <td> <button class="btn btn-primary btn-sm detail" dtat-id="${i}" data-name="${v.name}" data-gender="${v.gender}" data-email="${v.email}" data-address="${v.address}" data-profile="${v.profile}"> Details </button> 
